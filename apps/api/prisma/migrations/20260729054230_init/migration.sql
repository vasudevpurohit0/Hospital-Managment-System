...
CREATE TABLE "medicine_batches" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "maximum_stock_level" INTEGER NOT NULL DEFAULT 500,
...
-- CreateIndex
CREATE UNIQUE INDEX "beds_current_admission_id_key" ON "beds"("current_admission_id" ASC);

-- CreateIndex
CREATE INDEX "benefit_rules_employment_type_id_active_idx" ON "benefit_rules"("employment_type_id" ASC, "active" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "departments_code_key" ON "departments"("code" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "departments_name_key" ON "departments"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "discharge_summaries_admission_id_key" ON "discharge_summaries"("admission_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "doctor_profiles_user_id_key" ON "doctor_profiles"("user_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "employees_employee_id_key" ON "employees"("employee_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "employment_types_code_key" ON "employment_types"("code" ASC);

-- CreateIndex
CREATE INDEX "facility_eligibility_rules_grade_id_active_idx" ON "facility_eligibility_rules"("grade_id" ASC, "active" ASC);

-- CreateIndex
CREATE INDEX "facility_eligibility_rules_post_id_active_idx" ON "facility_eligibility_rules"("post_id" ASC, "active" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "hospital_uids_employee_id_key" ON "hospital_uids"("employee_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "hospital_uids_uid_code_key" ON "hospital_uids"("uid_code" ASC);

-- CreateIndex
CREATE INDEX "medicine_batches_expiry_date_idx" ON "medicine_batches"("expiry_date" ASC);

-- CreateIndex
CREATE INDEX "medicine_batches_stock_status_idx" ON "medicine_batches"("stock_status" ASC);

-- CreateIndex
CREATE INDEX "opd_visits_department_id_created_at_idx" ON "opd_visits"("department_id" ASC, "created_at" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "opd_visits_visit_id_key" ON "opd_visits"("visit_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "patient_profiles_employee_id_key" ON "patient_profiles"("employee_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "permissions_role_id_resource_action_key" ON "permissions"("role_id" ASC, "resource" ASC, "action" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "posts_title_key" ON "posts"("title" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "roles_name_key" ON "roles"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "users_employee_id_key" ON "users"("employee_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "users_identifier_key" ON "users"("identifier" ASC);

-- CreateIndex
CREATE INDEX "visits_employee_id_status_idx" ON "visits"("employee_id" ASC, "status" ASC);
...
-- AddForeignKey
ALTER TABLE "opd_visits" ADD CONSTRAINT "opd_visits_doctor_id_fkey" FOREIGN KEY ("doctor_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
